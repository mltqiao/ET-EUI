...
namespace ET
{
	...
	[EnableMethod]
	public  class DlgCharactorSelectViewComponent : Entity,IAwake,IDestroy 
	{
		...
		public UnityEngine.UI.LoopHorizontalScrollRect E_CharactorListLoopHorizontalScrollRect
     	{
     		get
     		{
     			if (this.uiTransform == null)
     			...
     			if( this.m_E_CharactorListLoopHorizontalScrollRect == null )
     			{
		    		this.m_E_CharactorListLoopHorizontalScrollRect = UIFindHelper.FindDeepChild<UnityEngine.UI.LoopHorizontalScrollRect>(this.uiTransform.gameObject,"E_CharactorList");
     			}
     			return this.m_E_CharactorListLoopHorizontalScrollRect;
     		}
     	}
		...
		public void DestroyWidget()
		{
			...
			this.m_E_CharactorListLoopHorizontalScrollRect = null;
		...
		private UnityEngine.UI.LoopHorizontalScrollRect m_E_CharactorListLoopHorizontalScrollRect = null;
