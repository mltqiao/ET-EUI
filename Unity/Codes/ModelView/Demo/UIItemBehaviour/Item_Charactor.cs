...
{
	[EnableMethod]
	public  class Scroll_Item_charactor : Entity,IAwake,IDestroy,IUIScrollItem 
	{
		...
		public Scroll_Item_charactor BindTrans(Transform trans)
		{
		...
		public UnityEngine.UI.Button E_DeleteRoleButton
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_DeleteRoleButton = UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_Role/CharactorSelectInfoTop/E_DeleteRole");
     				}
     				return this.m_E_DeleteRoleButton;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Button>(this.uiTransform.gameObject,"EG_Role/CharactorSelectInfoTop/E_DeleteRole");
     			}
     		}
     	}
		...
		public UnityEngine.UI.Image E_DeleteRoleImage
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_DeleteRoleImage = UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/CharactorSelectInfoTop/E_DeleteRole");
     				}
     				return this.m_E_DeleteRoleImage;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<UnityEngine.UI.Image>(this.uiTransform.gameObject,"EG_Role/CharactorSelectInfoTop/E_DeleteRole");
     			}
     		}
     	}
		...
		public TMPro.TextMeshProUGUI E_RoleLevelTextMeshProUGUI
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_RoleLevelTextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"EG_Role/CharactorInfo/E_RoleLevel");
     				}
     				return this.m_E_RoleLevelTextMeshProUGUI;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"EG_Role/CharactorInfo/E_RoleLevel");
     			}
     		}
     	}
		...
		public TMPro.TextMeshProUGUI E_RoleNameTextMeshProUGUI
     	{
     		get
     		{
     			...
     			if (this.isCacheNode)
     			{
     				...
     				{
		    			this.m_E_RoleNameTextMeshProUGUI = UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"EG_Role/CharactorInfo/E_RoleName");
     				}
     				return this.m_E_RoleNameTextMeshProUGUI;
     			}
     			else
     			{
		    		return UIFindHelper.FindDeepChild<TMPro.TextMeshProUGUI>(this.uiTransform.gameObject,"EG_Role/CharactorInfo/E_RoleName");
     			}
     		}
     	}
